...
#define nrn_init _nrn_init__TriangleIClamp
#define _nrn_initial _nrn_initial__TriangleIClamp
#define nrn_cur _nrn_cur__TriangleIClamp
#define _nrn_current _nrn_current__TriangleIClamp
#define nrn_jacob _nrn_jacob__TriangleIClamp
#define nrn_state _nrn_state__TriangleIClamp
#define _net_receive _net_receive__TriangleIClamp 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 TriangleIClamp D:/#GP/gradProject/model1/modFiles/TriangleIClamp.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   at_time ( _nt, del ) ;
   at_time ( _nt, del + durA ) ;
   at_time ( _nt, del + durA + durB ) ;
   if ( t < del ) {
     i = 0.0 ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "TriangleIClamp.mod";
static const char* nmodl_file_text = 
